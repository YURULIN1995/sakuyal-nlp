import styles from '@styles/TestimonialsModules/TestimonialPostCard.module.scss';
...
function PostCard({ fullText, authorName, authorTitle, imageUrl, imageAlt }) {
  return (
    <div className={styles.card}>
      ...
      <div className={styles.leftWrap}>
        <img src={imageUrl} alt={imageAlt} className={styles.avatar} />
          ...
          {authorTitle && <p className={styles.subtitle}>{authorTitle}</p>}
      </div>
