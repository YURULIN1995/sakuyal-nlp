...
export const portfoliosList = [
  ...
  },
  {
    id: 'portfolio-03',
    title: '作品03',
    description: '這是作品集項目三的詳細描述，說明了專案的背景、挑戰與成果。🐷🐷🐷🐷🐷🐷🐷�🐷🐷🐷',
    featuresListItem: [
      { id: 'feature-item-03-01', itemDescription: '特色亮點 (一)' },
      { id: 'feature-item-03-02', itemDescription: '特色亮點 (二)' },
      { id: 'feature-item-03-03', itemDescription: '特色亮點 (三)' },
      { id: 'feature-item-03-04', itemDescription: '特色亮點 (四)' },
      { id: 'feature-item-03-05', itemDescription: '特色亮點 (五)' }
    ],
    imageUrl: 'https://placehold.co/800x600/a9d3a4/4a6e4f',
    imageAlt: '作品03示意圖',
    isReversed: false,
