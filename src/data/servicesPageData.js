  ...
  lists: [
    {
      ...
      items: [
        ...
        { id: "applicable-02", text: "雖然還沒蓋網站，已經有自己的服務與產品，想要跳出平台競爭的人。" },
...
export const servicesFaq = {
  ...
  questionStacks: [
    {
      id: "faq-01",
      title: "建置網站的部份，會產生哪些持續支出的固定費用或變動成本嗎？",
      answer: "建置網站唯一會產生的固定費用是網域的年費，我目前買一個.com的網域年費約500元新台幣。我大量使用各種服務的免費版，剛好都能涵蓋初期需要的用量額度。網域費可能因網域商每年的政策調整。如果漲價漲的太誇張，可以諮詢我尋找其他的網域商，我將免費協助您網域內容搬家。\n 至於 CRM(客戶關係平台) 免費版的功能與群發信額度 很夠用，每個月可以寄出 1000封。就算隨著您的業務成長，有可能需要升級付費版，在精準導流的行銷網站上，訂閱費NT$300/月 不到，相當划算。我自己撰寫名單蒐集頁面，所以完全不會被CRM 平台商掛上它們家的Logo唷！ \n 網站後台和AI 訓練資料集的確會隨著業務規模擴張收取更多的費用，若您的成交客戶低於1000位，都還能使用平台的免費額度，不用擔心還沒賺到錢每個月被高昂的軟體訂閱費榨乾的問題。在系統可靠性與運算資源方面，我非常精打細算。"
    },
    {
      id: "faq-02",
      title: "建置網站要多久？",
      answer: "我提供3種方案，建置時間各異。我會先發布網站，再讓您到後台慢慢上傳素材，選好方案以後，請在指定時間內傳送站主基本資料給我，項目很少，您幾分鐘之內就能準備好。\n 方案一：套版網站（跟我的網站一樣），附單色自動調色盤的話，一天內就能上線。 \n 方案二：套版網站+部份微調，例如：根據圖片大小調整圖框大小，更換字型、字距，更改配色參數，2天可上線。 \n 方案三：完全客製，視畫面與功能複雜度而定，最少需要2~3個月才能上線。\n 加蓋購物車或會員系統的時間視規模與複雜度要另外計算。 \n 加蓋一個沒有促銷機制與折扣碼計算的普通購物車，大約要花3~4個月, \n 加蓋一個普通會員系統大約要花1~2個月。\n 我會建議您初期客戶尚未超過300人以前，先串接一些安全但廣用的平台，利用免費額度節省開銷。串接購物車API 1天，串接會員系統 1天。"
    },
    {
      id: "faq-03",
      title: "建置網站需要哪些素材？",
      answer: "Logo、品牌主色系選一種顏色、文案。您可以視需求追加其他多媒體類型。\n 如果您有影片，音檔要上傳，這都算在在客製化網站後台的工作範圍裡。\n 若您還沒有Logo或文案，我會與您溝通構想，提供工具協助您加速製作。\n 您可以在網站上線後到後台慢慢編輯。我的AI文案提示助手也會根據您的主題，一步步給您完成文案的提示。"
    },
    {
      id: "faq-04",
      title: "網站需要維護費嗎？",
      answer: "不需要。這個網站管理成本極低，你在後台可以自由變更/編輯素材。如果您想要自己調整圖框大小、微調配色參數、換字型、更改字距、行距，我都可以免費教您，你可以自己橋到滿意而不衍生支出。除非你有特殊需求，例如：新增功能、大改排版、後台新增管理面板數據種類...這個部份另立契約討論製作費。老客戶享有一年一次免費網域搬家服務，這是針對既有網域商漲價應對的措施。如果沒什麼狀況臨時要搬網域，搬一次網域收3000元（含網站相關API重新串接的費用）。"
    },
    {
      id: "faq-05",
      title: "我需要很會下AI 提示語 （Prompt）才能得到精準的回答嗎？",
      answer: "您不需要非常會下AI 提示語 才能使用。根據我個人的觀察，功能越廣泛的工具，需要超強的溝通能力才能使用。況且現行大部分語言模型的自然語言理解率表現好的達到60%~78%就已經算優秀。再怎樣也比不上有真實生活體驗的真人。所以這套模型我會與你溝通後，根據你的服務背景知識，設計成部份自動化的特化AI。我們不祈求AI萬能，但求能當個合格的實習生。限縮AI所需學習的任務，加上高質量的真人反饋，相信您可以輕鬆的把AI當作實習生指導。"
    },
    {
      id: "faq-06",
      title: "我跟你做的AI討論我的商業機密，會不會資料外洩？",
      answer: "你擁有完整的資料管理權限，這是完全針對你的服務所作的私用AI。我可能會從零開始訓練或使用開源模型框架微調，但我絕對不會讓你的資料混入公開訓練集。我也購買資安相關的服務妥善管理您的資料庫，請放心購買與使用。"
    },
  ]
};